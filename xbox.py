# MicroPython USB HID Xbox 360 游戏手柄示例
#
# 此示例演示创建一个 Xbox 360 游戏手柄 HID 设备
# Steam 游戏原生支持此格式
#
# 运行方法:
# 1. 确保已安装 usb-device-hid: mpremote mip install usb-device-hid
# 2. 运行示例: mpremote run xbox360_gamepad_example.py
# 3. mpremote 会因 USB 重新枚举而退出,此时示例正在运行
# 4. 重新连接查看输出: mpremote connect PORTNAME
...
class Xbox360Interface(HIDInterface):
    ...
    def __init__(self):
        ...
        super().__init__(
            ...
            set_report_buf=bytearray(0),  # 输出报告缓冲区大小为 0,因为手柄不接收来自主机的数据
